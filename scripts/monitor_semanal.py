#!/usr/bin/env python3
"""
Monitor Semanal — James COO
Roda toda segunda-feira às 8h (Brasília = 11h UTC)
Monitora: emails urgentes, calendário da semana, relatórios pendentes
"""
...
def run():
    ...
    report_lines.append("📁 CRONOGRAMAS DE OBRA")
    report_lines.append("")
    ...
    for conta in CONTAS:
        try:
            ...
            if alertas_email:
                ...
                total_alertas += len(alertas_email)
            else:
    ...
    report_lines.append("")
    report_lines.append("🤝 James — monitoramento ativo")
